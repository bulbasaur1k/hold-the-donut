...
pub mod client {
    ...
    pub use client_conn::{
        ClientConfig, ClientConnectionData, ClientHelloMutator, ClientSessionStore, EarlyDataError,
...
pub mod server {
    ...
    pub use server_conn::{
        Accepted, ClientHello, ProducesTickets, RawClientHelloHook, ResolvesServerCert,
